...
Note that then you will see now a ``(hofavenv)`` at the beginning of your terminal command line. This means that the environment is correctly activated and we can start working with it.
