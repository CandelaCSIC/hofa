...
The files in the `GitHub repository <https://github.com/CandelaCSIC/hofa>`_ are licensed under the `Apache License 2.0 <https://www.apache.org/licenses/LICENSE-2.0>`_. Please, visit the repository to obtain a copy of it.

Documentation
---------------

The online documentation (i.e., this website) is licensed under `Creative Commons Attribution 4.0 International (CC-BY 4.0) <https://creativecommons.org/licenses/by/4.0/>`_.
